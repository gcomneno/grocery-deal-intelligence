...
def main():
    raw = json.loads(RAW_PRODUCTS.read_text(encoding="utf-8"))

    flyer = json.loads(FLYER_JSON.read_text(encoding="utf-8"))["flyer"]
            ...
            output.append(
                {
                    ...
                    **variant,
                    ...
                    "verification": {
                        "locality": "verified",
                        "flyer_match": ("exact" if flyer_pages else "unmatched"),
    ...
    exact = sum(1 for item in output if item["verification"]["flyer_match"] == "exact")
